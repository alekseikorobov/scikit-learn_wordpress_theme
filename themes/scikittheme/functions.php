<?php
    ...
    */
    ...
    function style_theme(){
        ...
        wp_enqueue_style('gallery',get_stylesheet_directory_uri().'/css/sg_gallery.css');
        wp_enqueue_style('gallery-binder',get_stylesheet_directory_uri().'/css/sg_gallery-binder.css');
        wp_enqueue_style('gallery-dataframe',get_stylesheet_directory_uri().'/css/sg_gallery-dataframe.css');
        wp_enqueue_style('sg_gallery-rendered-html',get_stylesheet_directory_uri().'/css/sg_gallery-rendered-html.css');
        wp_enqueue_style('theme',get_stylesheet_directory_uri().'/css/theme.css');
    }
    function scripts_theme(){
        wp_enqueue_script('documentation_options',get_template_directory_uri().'/js/documentation_options.js');
        wp_enqueue_script('jquery');//,'https://scikit-learn.org/stable/_static/jquery.js');
        wp_enqueue_script('bootstrap',get_template_directory_uri().'/js/vendor/bootstrap.min.js',['jquery']);
        wp_enqueue_script('versionwarning',get_template_directory_uri().'/js/versionwarning.js'); 
    }
